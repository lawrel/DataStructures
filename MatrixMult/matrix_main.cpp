...
void StudentTest(){
	//setup for first few tests, using some of same matrices as above
	Matrix m1;
	Matrix m2(3,4,0);
	Matrix m3;
	Matrix m5(4,4,2);
	...
	assert(m7 == m8);
	assert(m7.add(m6));
	//inequality tests for cases involving NULL Matrix
	 assert(m1==m3);
	 assert(m1!=m2); //!= called on NULL
	 assert(m2!=m3); //!= called on filled compared to NULL
	//tests subtract 
	...
	//quadrants and makes sure values are nonzero
	std::cout<<"Return UL for different shaped matrices:"<<endl;
	Matrix m9(3,3,2);
	Matrix m10(5,4,3);
	Matrix m11(5,5,4);
	Matrix* ma1 = NULL;
...
void ExtraCreditTest(){
	cout<<"Shrink Matrix Both Ways:"<<endl;
	Matrix m0(3,3,2);
	cout<<"BEFORE: "<<m0;
	m0.resize(2,2,5);
	cout<<"AFTER: "<<m0;
	
	cout<<"Expand Matrix Both Ways:"<<endl;
	cout<<"BEFORE: "<<m0;
	m0.resize(4,4,5);
	cout<<"AFTER: "<<m0;
	
	Matrix m1(3,3,3);
	cout<<"Expand Rows, Shrink Columns:"<<endl;
	cout<<"BEFORE: "<<m1;
	m1.resize(4,2,7);
	cout<<"AFTER: "<<m1;
	
	Matrix m2(3,3,6);
	cout<<"Shrink Rows, Expand Columns:"<<endl;
	cout<<"BEFORE: "<<m2;
	m2.resize(2,4,7);
	cout<<"AFTER: "<<m2;
	
	Matrix m3(3,3,5);
	cout<<"Shrink Rows, Constant Columns:"<<endl;
	cout<<"BEFORE: "<<m3;
	m3.resize(2,3,7);
	cout<<"AFTER: "<<m3;
	
	Matrix m4(3,3,5);
	cout<<"Constant Rows, Shrink Columns:"<<endl;
	cout<<"BEFORE: "<<m4;
	m4.resize(3,2,7);
	cout<<"AFTER: "<<m4;
	
	Matrix m5(3,3,5);
	cout<<"Expand Rows, Constant Columns:"<<endl;
	cout<<"BEFORE: "<<m5;
	m5.resize(4,3,7);
	cout<<"AFTER: "<<m5;
	
	Matrix m6(3,3,5);
	cout<<"Constant Rows, Expand Columns:"<<endl;
	cout<<"BEFORE: "<<m6;
	m6.resize(3,4,7);
	cout<<"AFTER: "<<m6;
}
